...
- Home hero is a slider (.hero-home .hero-slides): LW light painting first (images/hero/lw-light), then B&W City-1, Landscapes-1 (harbor), City-2; 7s crossfade, dots, later slides load after page load. Spirit Box photo is images/Spirit_Box_V2(.jpg/-m.jpg).
